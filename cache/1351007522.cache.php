<?php $data=array('text'=>'',); ?><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<title>内容添加</title>
		<link href="http://xiaoqiqiu.com/view/css/add.css" type="text/css" rel="stylesheet"/>
    <link href="<?php echo  WEB_ROOT; ?>plugin/uploadify/uploadify.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="<?php echo  WEB_ROOT; ?>plugin/uploadify/jquery.uploadify-3.1.min.js"></script>
	</head>
	<body>
	<?php if(!isset($_SESSION['username'])){ ?>
    <?php  include_once(ROOT . '\error.html');exit; ?>
  <?php } ?>
          ...
          <script type="text/javascript">
            ...
            $("#file_upload").uploadify({
                ...
                'onUploadSuccess' : function(file, data, response) {
					...
					<p><a class="back" href="<?php echo  WEB_ROOT; ?>index">返回首页</a></p>
			</form>
		</div>
	</body>
