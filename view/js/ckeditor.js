(function () {
  ...
  if (!window.CKEDITOR) {
    window.CKEDITOR = (function () {
      var a = {
        ...
        status: "unloaded",
        basePath: (function () {
          var d = window.CKEDITOR_BASEPATH || "http://xiaoqiqiu.com/ckeditor/";
          if (!d) {
    ...
    a.tools = {
      ...
      extend: function (f) {
        ...
        if (typeof (h = arguments[g - 1]) == "boolean") {
          ...
          if (typeof (h = arguments[g - 2]) == "boolean") {
            i = arguments[g - 1];
            g -= 2
          }
        }
    ...
    copyAttributes: function (i, j) {
      ...
      for (var l = 0; l < k.length; l++) {
        ...
        if (n == "checked" && (o = p.getAttribute(n))) {
          ...
          if (m.specified || c && m.nodeValue && n == "value") {
            o = p.getAttribute(n);
            if (o === null) {
              o = m.nodeValue
            }
          ...
          while (z || A) {
            ...
            while (A) {
              ...
              if (A.type == 3) {
                ...
                if ((A.$.offsetWidth > 0 || u && A.is("br")) && !A.data("cke-bookmark")) {
          ...
          while (u) {
            if (u.type == 1) {
              if (u.getAttribute("contentEditable") == "false" && !u.data("cke-editable")) {
                ...
                if (u.is("html") || u.getAttribute("contentEditable") == "true" && (u.contains(v) || u.equals(v))) {
                  break
                }
              }
            }
  ...
  j.add('insertcode', {
    ...
    init: function(l){
      ...
      l.ui.addButton('insertcode', {
        label: l.lang.insertcode.toolbar,
        command: 'insertcode',
      ...
      q = function (y) {
        ...
        case 2228224 + 45:
          ...
          if (!c && z.fire("beforepaste")) {
            ...
            if (b.opera || b.gecko && b.version < 10900) {
              z.fire("paste")
            }
          }
          return;
        ...
        o.on("selectionChange", function (x) {
          ...
          while (A) {
            ...
            if (A.data("cke-display-name")) {
              ...
              if (A.data("cke-real-element-type")) {
    ...
    function r(v, w, x, y) {
      ...
      for (var B in y) {
        ...
        if (z.filebrowser.action == "Browse") {
          ...
          if (z.filebrowser.action == "QuickUpload" && z["for"]) {
            D = z.filebrowser.url;
            if (D === undefined) {
        ...
        if (r.is("form")) {
          ...
          if (r.is("select")) {
            ...
            if (r.is("textarea")) {
              ...
              if (r.is("img") && r.data("cke-real-element-type") == "hiddenfield") {
      ...
      m.on("doubleclick", function (p) {
        ...
        if (!q.isReadOnly()) {
          if (q.is("a")) {
            ...
            if (j.link.tryRestoreFakeAnchor(m, q)) {
        ...
        while (1) {
          ...
          if (T.indent == P) {
            ...
            if (T.indent == Math.max(P, 0) + 1) {
              ...
              if (T.indent == -1 && !I && T.grandparent) {
                if (m[T.grandparent.getName()]) {
                  Q = T.element.clone(false, true)
                } else {
                  if (K || T.element.hasAttributes() || J != 2) {
                    Q = L.createElement(S);
      ...
      exec: function (G) {
        ...
        while (P.length > 0) {
          ...
          if (this.state == 2) {
            ...
            if (this.state == 1 && m[ag.root.getName()]) {
              w.call(this, G, ag, Q)
            }
          }
        }
          ...
          if ((s = r.html) && (o || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(s))) {
            var t = this.loadFilterRules(function () {
              if (t) {
                ...
                if (!n.config.pasteFromWordPromptCleanup || o || confirm(n.lang.pastefromword.confirmCleanup)) {
      ...
      s = {
        ...
        exec: function (t) {
          if (q.isScaytReady(t)) {
            ...
            if (!t.config.scayt_autoStartup && q.engineLoaded >= 0) {
              this.setState(0);
              q.loadEngine(t)
            }
          }
  ...
  i.toolbar_Basic = [
    ["Bold", "Italic", "-", "NumberedList", "BulletedList", "-", "Link", "Unlink", "-", "About","insertcode"]
  ];
  i.toolbar_Full = [{
    name: "document",
    ...
    a.dialog = function (S, T) {
      ...
      function ak(ar) {
        ...
        if (as == 9 || as == 2228224 + 9) {
          ...
          if (as == 4456448 + 121 && !af._.tabBarMode && af.getPageCount() > 1) {
            af._.tabBarMode = true;
            af._.tabs[af._.currentTabId][0].focus();
            aj = 1
          } else {
            if ((as == 37 || as == 39) && af._.tabBarMode) {
              av = as == (at ? 39 : 37) ? o.call(af) : p.call(af);
              af.selectPage(av);
              af._.tabs[av][0].focus();
              aj = 1
            } else {
              if ((as == 13 || as == 32) && af._.tabBarMode) {
    ...
    function A(S) {
      ...
      function Z(ab) {
        ...
        if (U.x + Y[3] < X) {
          ...
          if (U.x - Y[1] > ad.width - ac.width - X) {
        ...
        if (U.y + Y[0] < X) {
          ...
          if (U.y - Y[2] > ad.height - ac.height - X) {
      ...
      getNextParagraph: function (s) {
        ...
        if (!t) {
          ...
          if (!t && !S.enforceRealBlocks && O[N.getName()] && u.checkStartOfBlock() && u.checkEndOfBlock()) {
            ...
            if (!t || S.enforceRealBlocks && t.getName() == "li") {
        ...
        if (x) {
          ...
          if (Q && Q.type == 1) {
            if (Q.getName() == "br") {
              ...
              if (Q.getLast() && Q.getLast().$.nodeName.toLowerCase() == "br") {
                Q.getLast().remove()
              }
            }
          }
